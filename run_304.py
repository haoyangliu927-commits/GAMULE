...
# %%
ADATA_PATH = REPO_ROOT / "datasets/adata_304.h5ad"
TREE_XML_PATH = REPO_ROOT.parents[1] / "sc_simulator-main" / "sim_data" / "trees" / "tree_304.xml"
...
if TREE_XML_PATH.exists():
    ...
    print(f"Warning: tree XML not found, skip cell type and hierarchy accuracy: {TREE_XML_PATH}")
